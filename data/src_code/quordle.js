...
var Ce = (e, s, t) =>
    new Promise((l, i) => {
        var n = (a) => {
            ...
            c = (a) =>
                a.done ? l(a.value) : Promise.resolve(a.value).then(n, o);
...
var Fa = Qe((We) => {
    ...
    const ds =
        ...
        us =
            ...
            navigator.canShare({
                ...
                files: [
                    new File([new Blob()], "test.png", { type: "image/png" }),
                ],
            }),
        ...
        ["daily", "free"].forEach((o) => {
            ...
            try {
                const a = Number(window.localStorage.getItem("last_" + o)),
                    ...
                    g = Number(
                        window.localStorage.getItem(o + "_current_streak") || 0
                    ),
                    b = Number(
                        window.localStorage.getItem(o + "_max_streak") || 0
                    );
                if (a && (o === "free" || a === s)) {
                    const y = r ? r.split(",") : [],
                        f = ne(a);
    ...
    const $e = He(),
        ys = (e) => {
            const [s, t] = gs(),
                l = (a) =>
                    ...
                    s[a].answers.filter((r) => s[a].guesses.indexOf(r) >= 0)
                        .length === 4,
                i = (a, r) => {
                    t(
                        H((d) => {
                            d[a].current.length < 5 &&
                                !l(a) &&
                                (d[a].current += r);
                        })
                    );
                    ...
                    t(
                        H((r) => {
                            if (
                                ...
                                for (let m = 0; m < V; m++) {
                                    const g = r[a].guesses.indexOf(
                                        r[a].answers[m]
                                    );
                                    (g === -1 ||
                                        g === r[a].guesses.length - 1) &&
                                        r[a].states[m].push(
                                            Oe(d, r[a].answers[m])
                                        ),
                                        (r[a].answersCorrect[m] = r[
                                            a
                                        ].guesses.indexOf(r[a].answers[m]));
                                }
                                if (
                                    (L("event", "guess", {
                                        mode: a,
                                        daily_seed:
                                            a === "daily" ? r[a].seed : void 0,
                                        word: d,
                                    }),
                                    l(a))
                                ) {
                ...
                c = [
                    s,
                    {
                        ...
                        resetDailyIfOld() {
                            const r =
                                ((new Date().getTime() - ze.getTime()) / _e) >>
                                0;
                            r !== s.daily.seed &&
                                t(
                                    H((d) => {
        ...
        Q = () => {
            ...
            if (!e || !e.length)
                throw new Error(
                    "GamesDataContext has been used outside provider"
                );
            return e;
        },
        bs = p(
        ...
        De = (e) =>
            (() => {
                ...
                return (
                    M(() => E(s, "height", (e.height ? e.height : 16) + "px")),
                    s
                );
            })(),
        Rs = (e) =>
        ...
        Xs = (e) => {
            const [s, t] = Q(),
                l = _(() =>
                    s[e.mode].answersCorrect.reduce(
                        (a, r) => (a += r >= 0 ? 1 : 0),
                        0
                    )
                ),
...
`;
                ...
                return (
                    M(
                        (i) => {
                            const n = {
                                    "bg-box-correct":
                                        e.state === "correct" && !e.colorblind,
                                    "bg-box-correct-alt":
                                        e.state === "correct" && e.colorblind,
                                    "bg-box-diff":
                                        e.state === "diff" && !e.colorblind,
                                    "bg-box-diff-alt":
                                        e.state === "diff" && e.colorblind,
                                    "bg-gray-200 dark:bg-gray-700":
                                        e.state === "none" &&
                                        e.rowTemporalState === "past",
    ...
    oe(["click"]);
    const ca = p(
            '<button class="quordle-key bg-zinc-300 dark:bg-zinc-600 pb-[calc(10%-0.25rem)]"><div class="quordle-box-content"> </div></button>'
        ),
                ...
                if (!!Array.isArray(o))
                    for (const c of o) {
                        ...
                        if (!d || d.width !== a || d.height !== r) {
                            ...
                            e.onResize(m, c.target),
                                i.set(c.target, { width: a, height: r });
                        }
                    }
            });
        return (
                ...
                return (
                    ...
                    u(
                        ...
                        h(ye, {
                            ...
                            onClick: () => j(s.vibration),
                            onChange: (r) =>
                                t.setDarkMode(r.currentTarget.checked),
                        }),
                        null
                    ),
                    u(
                        ...
                        h(ye, {
                            ...
                            onClick: () => j(s.vibration),
                            onChange: (r) =>
                                t.setColorblind(r.currentTarget.checked),
                        }),
                        null
                    ),
                    u(
                        ...
                        Ie &&
                            h(ye, {
                                ...
                                onClick: () => j(s.vibration),
                                onChange: (r) =>
                                    t.setVibration(r.currentTarget.checked),
                            }),
                        null
                    ),
                    u(
                        ...
                        h(ye, {
                            ...
                            onClick: () => j(s.vibration),
                            onChange: (r) =>
                                t.setEnterBsReversed(r.currentTarget.checked),
                        }),
                        null
                    ),
                    u(
    ...
    const va = p(
        ...
        qa = (e) => {
            const [s, t] = Q(),
                ...
                a = _(() =>
                    s[e.mode].history.slice(S).reduce((y, f) => y + f, 0)
                ),
                r = _(() => c() + a()),
                d = _(() =>
                    s[e.mode].answersCorrect.reduce(
                        ...
                        h(fe, {
                            ...
                            get children() {
                                return h(wa, {
                                    ...
                                    onCloseSettings: () => {
                                        j(s.vibration), i({ overlay: void 0 });
                                    },
                                });
                            },
                        }),
